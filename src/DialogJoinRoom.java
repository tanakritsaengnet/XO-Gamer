...
public class DialogJoinRoom extends javax.swing.JDialog {
    ...
    public DialogJoinRoom(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("IP Destination");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel2.add(jButtonBack, gridBagConstraints);

        jButtonJoin.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jPanel2.add(jButtonJoin, gridBagConstraints);
    ...
    private void jButtonBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBackActionPerformed
        FrameHome framHome = new FrameHome();
        framHome.setVisible(true);
    ...
    private void doJoinRoom() {
        ...
        xo.joinRoom(jTextField1.getText(), jTextField2.getText());
        dispose();
    }
