...
public class DialogCreateRoom extends javax.swing.JDialog {
    ...
    public DialogCreateRoom(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonCreate.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
    ...
    private void doCreateRoom() {
        ...
        xo.createRoom(jTextField1.getText(), jTextField2.getText());
        dispose();
    }
